 ...
 * 修改模块引用方式
 **/
var nest = function (canvasEle ,params) {
  ...
  function get_config_option() {
    ...
    return {
      z: params.zIndex || -1, //z-index
      o: params.opacity || 0.5, //opacity
      c: params.color || "0,0,0", //color
      n: params.count || 99 //count
    };
  }
  //设置canvas的高宽
  ...
  //创建画布，并添加到body中
  var canvas = document.querySelector(canvasEle), //画布
